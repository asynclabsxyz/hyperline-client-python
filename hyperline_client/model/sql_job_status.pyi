...
class SqlJobStatus(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["job_id", "job_status", "job_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["job_id", "job_status", "job_type", ], str]):
