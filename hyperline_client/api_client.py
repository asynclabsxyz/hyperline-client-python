...
import hyperline_client.models
from hyperline_client import rest
from hyperline_client.exceptions import ApiValueError, ApiException
    ...
    def __call_api(
        ...
        if _preload_content or _return_http_data_only:
          ...
          if response_type == "bytearray":
              ...
              match = None
              content_type = response_data.getheader('content-type').rstrip("; charset=UTF-8")
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(hyperline_client.models, klass)
