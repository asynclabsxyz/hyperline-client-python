...
class SparkJobStatus(BaseModel):
    """
    ...
    __properties = ["job_id", "job_type", "job_status", "status_timestamp"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SparkJobStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SparkJobStatus:
        """Create an instance of SparkJobStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SparkJobStatus.parse_obj(obj)

        _obj = SparkJobStatus.parse_obj({
