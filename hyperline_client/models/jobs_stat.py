...
class JobsStat(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobsStat:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobsStat:
        """Create an instance of JobsStat from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobsStat.parse_obj(obj)

        _obj = JobsStat.parse_obj({
            "value": obj.get("value"),
