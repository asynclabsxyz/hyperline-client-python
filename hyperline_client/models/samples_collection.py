...
class SamplesCollection(BaseModel):
    """
    SamplesCollection
    """
    samples: conlist(Sample) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SamplesCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SamplesCollection:
        """Create an instance of SamplesCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SamplesCollection.parse_obj(obj)

        _obj = SamplesCollection.parse_obj({
