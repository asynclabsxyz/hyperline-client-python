...
class SqlQueryCollection(BaseModel):
    """
    A Sql Query collection object.
    """
    queries: Optional[conlist(SqlQuery)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SqlQueryCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SqlQueryCollection:
        """Create an instance of SqlQueryCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SqlQueryCollection.parse_obj(obj)

        _obj = SqlQueryCollection.parse_obj({
            "queries": [SqlQuery.from_dict(_item) for _item in obj.get("queries")] if obj.get("queries") is not None else None
        })
        return _obj
