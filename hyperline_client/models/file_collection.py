...
class FileCollection(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FileCollection:
        """Create an instance of FileCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileCollection.parse_obj(obj)

        _obj = FileCollection.parse_obj({
