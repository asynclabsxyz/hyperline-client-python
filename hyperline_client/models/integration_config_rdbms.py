...
class IntegrationConfigRDBMS(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IntegrationConfigRDBMS:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IntegrationConfigRDBMS:
        """Create an instance of IntegrationConfigRDBMS from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IntegrationConfigRDBMS.parse_obj(obj)

        _obj = IntegrationConfigRDBMS.parse_obj({
            "user": obj.get("user"),
