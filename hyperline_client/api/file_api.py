...
class FileApi(object):
    ...
    @validate_arguments
    def delete_file(self, path : Annotated[StrictStr, Field(..., description="The path of the file/dataset.")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the delete_file_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.delete_file_with_http_info(path, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_file_with_http_info(self, path : Annotated[StrictStr, Field(..., description="The path of the file/dataset.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a file  # noqa: E501
    ...
    @validate_arguments
    def download_file(self, path : Annotated[StrictStr, Field(..., description="The path of the file/dataset.")], **kwargs) -> File:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the download_file_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.download_file_with_http_info(path, **kwargs)  # noqa: E501

    @validate_arguments
    def download_file_with_http_info(self, path : Annotated[StrictStr, Field(..., description="The path of the file/dataset.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Downloads a file  # noqa: E501
