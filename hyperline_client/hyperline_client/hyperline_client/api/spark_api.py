...
class SparkApi(object):
    ...
    @validate_arguments
    def spark_get_sql(self, **kwargs) -> File:  # noqa: E501
        ...
        >>> thread = api.spark_get_sql(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the spark_get_sql_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.spark_get_sql_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def spark_get_sql_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get user Spark SQL query cache  # noqa: E501
        ...
        >>> thread = api.spark_get_sql_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def spark_save_job(self, job_id : Annotated[StrictStr, Field(..., description="The Job ID.")], **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.spark_save_job(job_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.spark_save_job_with_http_info(job_id, **kwargs)  # noqa: E501

    @validate_arguments
    def spark_save_job_with_http_info(self, job_id : Annotated[StrictStr, Field(..., description="The Job ID.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Save a spark job for pipeline  # noqa: E501
        ...
        >>> thread = api.spark_save_job_with_http_info(job_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def spark_submit_sql(self, sql_query : SqlQuery, **kwargs) -> SqlExecuteResponse:  # noqa: E501
        """Submit a Spark SQL job  # noqa: E501

        Submit a Spark job to run a sql query inside a python spark template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.spark_submit_sql(sql_query, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the spark_submit_sql_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.spark_submit_sql_with_http_info(sql_query, **kwargs)  # noqa: E501

    @validate_arguments
    def spark_submit_sql_with_http_info(self, sql_query : SqlQuery, **kwargs) -> ApiResponse:  # noqa: E501
        """Submit a Spark SQL job  # noqa: E501
        ...
        >>> thread = api.spark_submit_sql_with_http_info(sql_query, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method spark_submit_sql" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def spark_update_sql(self, file : File, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.spark_update_sql(file, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the spark_update_sql_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.spark_update_sql_with_http_info(file, **kwargs)  # noqa: E501

    @validate_arguments
    def spark_update_sql_with_http_info(self, file : File, **kwargs) -> ApiResponse:  # noqa: E501
        """Update user Spark SQL query cache  # noqa: E501
        ...
        >>> thread = api.spark_update_sql_with_http_info(file, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method spark_update_sql" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
