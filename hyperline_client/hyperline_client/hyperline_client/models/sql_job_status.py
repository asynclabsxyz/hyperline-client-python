...
class SqlJobStatus(BaseModel):
    ...
    __properties = ["job_id", "job_type", "job_status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SqlJobStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SqlJobStatus:
        """Create an instance of SqlJobStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SqlJobStatus.parse_obj(obj)

        _obj = SqlJobStatus.parse_obj({
