...
request_body_pipeline_backfill_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _backfill_pipeline_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_pipeline_backfill_request.serialize(body, content_type)
...
class BackfillPipeline(BaseApi):
    ...
    def backfill_pipeline(
        ...
        return self._backfill_pipeline_oapg(
            body=body,
