...
# body param
SchemaForRequestBodyApplicationJson = SparkJobSubmitRequest


request_body_spark_job_submit_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _spark_submit_job_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_spark_job_submit_request.serialize(body, content_type)
...
class SparkSubmitJob(BaseApi):
    ...
    def spark_submit_job(
        ...
        return self._spark_submit_job_oapg(
            body=body,
