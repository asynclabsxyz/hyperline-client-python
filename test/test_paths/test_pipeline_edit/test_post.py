...
from hyperline_hyperline_client.client.paths.pipeline_edit import post  # noqa: E501
from hyperline_hyperline_client.client import configuration, schemas, api_hyperline_client.client

from .. import ApiTestMixin


class TestPipelineEdit(ApiTestMixin, unittest.TestCase):
    """
    PipelineEdit unit test stubs
