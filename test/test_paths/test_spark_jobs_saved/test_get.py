...
from hyperline_hyperline_client.client.paths.spark_jobs_saved import get  # noqa: E501
from hyperline_hyperline_client.client import configuration, schemas, api_hyperline_client.client

from .. import ApiTestMixin


class TestSparkJobsSaved(ApiTestMixin, unittest.TestCase):
    """
    SparkJobsSaved unit test stubs
