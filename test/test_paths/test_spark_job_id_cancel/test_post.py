...
from hyperline_hyperline_client.client.paths.spark_job_id_cancel import post  # noqa: E501
from hyperline_hyperline_client.client import configuration, schemas, api_hyperline_client.client

from .. import ApiTestMixin


class TestSparkJobIdCancel(ApiTestMixin, unittest.TestCase):
    """
    SparkJobIdCancel unit test stubs
