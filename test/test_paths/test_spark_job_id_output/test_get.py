...
from hyperline_hyperline_client.client.paths.spark_job_id_output import get  # noqa: E501
from hyperline_hyperline_client.client import configuration, schemas, api_hyperline_client.client

from .. import ApiTestMixin


class TestSparkJobIdOutput(ApiTestMixin, unittest.TestCase):
    """
    SparkJobIdOutput unit test stubs
