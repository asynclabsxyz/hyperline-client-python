...
from hyperline_hyperline_client.client.paths.pipelines_pipeline_name import get  # noqa: E501
from hyperline_hyperline_client.client import configuration, schemas, api_hyperline_client.client

from .. import ApiTestMixin


class TestPipelinesPipelineName(ApiTestMixin, unittest.TestCase):
    """
    PipelinesPipelineName unit test stubs
