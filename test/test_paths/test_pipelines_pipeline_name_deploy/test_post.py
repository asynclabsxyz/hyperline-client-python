...
from hyperline_hyperline_client.client.paths.pipelines_pipeline_name_deploy import post  # noqa: E501
from hyperline_hyperline_client.client import configuration, schemas, api_hyperline_client.client

from .. import ApiTestMixin


class TestPipelinesPipelineNameDeploy(ApiTestMixin, unittest.TestCase):
    """
    PipelinesPipelineNameDeploy unit test stubs
